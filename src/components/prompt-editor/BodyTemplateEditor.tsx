    ...
    <div className="mb-2">
      <div className="mb-2 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex w-full flex-wrap items-center gap-2 sm:w-auto">
          <Button variant="secondary" size="sm" onClick={onInsertVariable} className="h-10 flex-1 whitespace-nowrap sm:h-auto sm:flex-none">
            <Code className="mr-1.5 h-3.5 w-3.5" />
            Insert variable
          </Button>
          {onCopyPrompt && (
            <Button variant="secondary" size="sm" onClick={onCopyPrompt} className="h-10 flex-1 whitespace-nowrap sm:h-auto sm:flex-none">
      ...
      <div className="rounded-lg border border-[var(--color-border)] bg-[var(--color-panel)] overflow-hidden focus-within:border-[var(--color-primary)] focus-within:ring-2 focus-within:ring-[var(--color-primary)]/20">
        ...
        <div
          id="body-footer"
          className="flex flex-col gap-2 border-t border-[var(--color-border)] px-4 py-2 text-xs text-[var(--color-text-muted)] sm:flex-row sm:items-center sm:justify-between"
        >
          <button
            type="button"
            onClick={onToggleFormattingHelp}
            className="flex min-h-10 items-center gap-1 transition-colors hover:text-[var(--color-primary)] sm:min-h-0"
          ...
          <div className="flex items-center justify-between gap-3 sm:justify-start">
            ...
            <button
              ...
              className="flex h-10 w-10 items-center justify-center rounded-md transition-colors hover:bg-gray-100 hover:text-[var(--color-primary)] sm:h-auto sm:w-auto"
