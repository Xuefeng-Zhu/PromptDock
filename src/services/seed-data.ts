...
export const SEED_RECIPES: SeedRecipeData[] = [
  ...
  },
  {
    ...
    body: `Create a PromptDock prompt recipe as a single valid JSON object.\n\nRequirements:\n- Output JSON only, with no Markdown.\n- Include required fields: "title" and "body".\n- Optional fields may include: "description", "tags", "folder", "favorite", and "variables".\n- In the generated prompt body, use PromptDock variables by wrapping variable names in two opening and two closing curly braces.\n- If the body includes variables, include a "variables" array with one object per variable name used in the body.\n- Each variable object must include "name" and may include "description", "defaultValue", "inputType", and "options".\n- Use "inputType": "text" for short values, "textarea" for long or multi-line values, and "dropdown" for constrained choices.\n- Dropdown variables must include non-empty "options"; if "defaultValue" is set, it must match one option exactly.\n- Do not include app-owned fields like id, workspaceId, createdAt, updatedAt, createdBy, version, archived, or lastUsedAt.\n\nPrompt I want to create:\n{{prompt_goal}}\n\nReturn this shape:\n{\n  "title": "...",\n  "description": "...",\n  "body": "...",\n  "variables": [\n    {\n      "name": "...",\n      "description": "...",\n      "defaultValue": "",\n      "inputType": "text",\n      "options": []\n    }\n  ],\n  "tags": ["..."],\n  "folder": "...",\n  "favorite": false\n}`,
